...
(function (factory) {
  ...
  $.extend(prototype, {
    ...
    initCropBox: function () {
    	...
    	var cropParam = this.options.cropParam;
    	if(cropParam != null){
    		canvas = this.canvas;
    		var cropBox = {};
    		cropBox.width = cropParam.w;
    		cropBox.height = cropParam.h;
    		cropBox.left = cropBox.oldLeft = canvas.left + cropParam.x;
    		cropBox.top = cropBox.oldTop = canvas.top + cropParam.y;
